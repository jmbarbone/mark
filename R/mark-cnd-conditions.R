...
#'   _no help documentation provided_
#'  }
#'   \subsection{`mark:class_error/error`}{
#'   \describe{
#'     \item{package}{`{mark}`}
#'     \item{class}{`mark:class_error`}
#'     \item{type}{**error**}
#'   }
#'   Generic error to indicate a class mismatch.
#'  }
#'   \subsection{`mark:default_tz_value/error`}{
#'   \describe{
#'     \item{package}{`{mark}`}
#'     \item{class}{`mark:default_tz_value`}
#'     \item{type}{**error**}
#'   }
#'   option(mark.default_tz) must be a character vector of length 1L, a function that returns a character vector of length 1L, NULL (defaults to UTC), or "system" to set to system timezone
#'  }
...
#'   _no help documentation provided_
#'  }
#'   \subsection{`mark:diff_time_error/error`}{
#'   \describe{
#'     \item{package}{`{mark}`}
#'     \item{class}{`mark:diff_time_error`}
#'     \item{type}{**error**}
#'   }
#'   _no help documentation provided_
#'  }
#'   \subsection{`mark:diff_time_warning/warning`}{
#'   \describe{
#'     \item{package}{`{mark}`}
#'     \item{class}{`mark:diff_time_warning`}
#'     \item{type}{**warning**}
#'   }
#'   _no help documentation provided_
#'  }
...
#'   ```
#'  }
#'   \subsection{`mark:input_error/error`}{
#'   \describe{
#'     \item{package}{`{mark}`}
#'     \item{class}{`mark:input_error`}
#'     \item{type}{**error**}
#'   }
#'   Generic error to indicate a bad input value.
#'  }
#'   \subsection{`mark:input_warning/warning`}{
#'   \describe{
#'     \item{package}{`{mark}`}
#'     \item{class}{`mark:input_warning`}
#'     \item{type}{**warning**}
#'   }
#'   Generic warning to indicate a bad input value.
#'  }
...
#'   _no help documentation provided_
#'  }
#'   \subsection{`mark:na_timezone_found/warning`}{
#'   \describe{
#'     \item{package}{`{mark}`}
#'     \item{class}{`mark:na_timezone_found`}
#'     \item{type}{**warning**}
#'   }
#'   _no help documentation provided_
#'  }
...
#'   _no help documentation provided_
#'  }
#'   \subsection{`mark:numeric_datetime_tz/error`}{
#'   \describe{
#'     \item{package}{`{mark}`}
#'     \item{class}{`mark:numeric_datetime_tz`}
#'     \item{type}{**error**}
#'   }
#'   ```r
#'   # Instead of this:
...
#'   _no help documentation provided_
#'  }
#'   \subsection{`mark:timezone_not_found/error`}{
#'   \describe{
#'     \item{package}{`{mark}`}
#'     \item{class}{`mark:timezone_not_found`}
#'     \item{type}{**error**}
#'   }
#'   When using a string for a timezone, this value must be found within `OlsonNames()`
#'  }
#'   \subsection{`mark:type_error/error`}{
#'   \describe{
#'     \item{package}{`{mark}`}
#'     \item{class}{`mark:type_error`}
#'     \item{type}{**error**}
#'   }
#'   Generic error to indicate a type mismatch.
#'  }
#'   \subsection{`mark:value_error/error`}{
#'   \describe{
#'     \item{package}{`{mark}`}
#'     \item{class}{`mark:value_error`}
#'     \item{type}{**error**}
#'   }
#'   Generic error to indicate a value mismatch.
#'  }
#'   \subsection{`mark:value_warning/warning`}{
#'   \describe{
#'     \item{package}{`{mark}`}
#'     \item{class}{`mark:value_warning`}
#'     \item{type}{**warning**}
#'   }
#'   Generic warning to indicate a value mismatch.
#'  }
